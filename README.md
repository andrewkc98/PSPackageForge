...
A full generated example is in [`Examples/SevenZip`](Examples/SevenZip).
...
<!-- TODO (Andrew): add a measured before/after here if you have one, e.g. "Packaging a new EXE
     went from about X minutes of research to about Y minutes of review." Leave this out
     entirely rather than estimate. -->
...
The full reference covers evidence precedence, the detection script contract, the EXE signature table, the lower-level cmdlets, the roadmap, and what is out of scope. See [`docs/REFERENCE.md`](docs/REFERENCE.md).
